...
---
## はじめに
IT関連の業務では数多くの略語が使われます。略語の方は知っているけど、正式名称が分からないという場面に出くわすことがあります。
この記事では、自分の備忘録も兼ねて、IT・ビジネス関連の略語をまとめています。少しずつ更新していきます。
...
| CAM | キャム | Computer Aided Manufacturing | コンピュータ支援製造 |
| CC | - | Carbon Copy | - |
...
| Favicon | ファビコン | Favorite icon | お気に入りアイコン |
...
| POS | ポス | Point of Sale | 販売時点情報管理 |
| PP | - | Program Product | プログラム製品 |
| PR | - | Public Relations | - |
| PR | - | Pull Request | - |
| PT | - | Part Test | 単体テスト |
...
| YAML | ヤムル | YAML Ain't a Markup Language | - |
| YAU | - | Yearly Active Users | 年次アクティブユーザ |
...
## おわりに
間違いを発見した方や追加してほしい略語がある方は、コメントを頂ければ幸いです。